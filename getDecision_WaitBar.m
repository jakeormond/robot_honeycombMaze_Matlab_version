function platform = getDecision_WaitBar(currentPlat, possiblePlats, platCoor, cropNums, minPlatTime)
%
...
while true
    counter3 = counter3 + 1;
    drawnow;
    % poll keypress, any keypress causes exit
%     if ~isempty(exitKey)
%         kbhit('stop')  
%         pause(0.1)
%         flush(u)
...
%     end
    ...
    if ~ishandle(hWaitbar)
        ...
        waitbar(counter3/2000,hWaitbar, ['Iteration ' num2str(counter3)]);
    end
